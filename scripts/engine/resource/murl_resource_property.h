...
#ifndef __MURL_RESOURCE_PROPERTY_H__
#define __MURL_RESOURCE_PROPERTY_H__
...
namespace Murl
{
    namespace Resource
    {
        ...
        public:
            ...
            Bool DeserializeValue(const IAttributes* att, const String& name)
            {
                Bool err;
                Bool ret = att->GetValueByName(name, 0, TypedScalarProperty<DataType>::mValue, err);
                if (err)
                {
                    ret = false;
                }
        ...
        public:
            ...
            {
                Bool err;
                Bool ret = att->GetValueByName(name, 0, mValue, err);
                if (err)
                {
                    ret = false;
                }
        ...
        public:
            ...
            Bool SerializeValue(IAttributes* att, const String& name) const
            {
                String s = Util::BoolToString(BoolPropertyBase::mValue);
                return att->AddAttribute(name, s);
            }
        };
        ...
        public:
            ...
            Bool SerializeValue(IAttributes* att, const String& name) const
            {
                String s = Util::SInt32ToString(SInt32PropertyBase::mValue);
                return att->AddAttribute(name, s);
            }
        };
        ...
        public:
            ...
            Bool SerializeValue(IAttributes* att, const String& name) const
            {
                String s = Util::UInt32ToString(UInt32PropertyBase::mValue);
                return att->AddAttribute(name, s);
            }
        };
        ...
        public:
            ...
            Bool SerializeValue(IAttributes* att, const String& name) const
            {
                String s = Util::DoubleToString(RealPropertyBase::mValue);
                return att->AddAttribute(name, s);
            }
        };
        ...
        public:
            ...
            Bool SerializeValue(IAttributes* att, const String& name) const
            {
                String s = Util::ColorToString(ColorPropertyBase::mValue);
                return att->AddAttribute(name, s);
            }
        };
        ...
        public:
            ...
            Bool SerializeValue(IAttributes* att, const String& name) const
            {
                return att->AddAttribute(name, mValue);
            }
        };
        ...
        public:
            ...
            Bool DeserializeEnumValue(const IAttributes* att, const String& name)
            {
                Bool err;
                Bool ret = att->GetEnumValueByName(name, 0, TypedEnumProperty<EnumType>::GetEnum(), mValue, err);
                if (err)
                {
                    ret = false;
                }
            ...
            Bool SerializeEnumValue(IAttributes* att, const String& name) const
            {
                Bool err;
                String s = TypedEnumProperty<EnumType>::GetEnum().GetEnumNameByValue(mValue, err);
                if (err)
                {
                    return false;
                }
