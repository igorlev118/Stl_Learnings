...
#ifndef __MURL_AUDIO_I_OBJECT_H__
#define __MURL_AUDIO_I_OBJECT_H__
...
namespace Murl
{
    namespace Audio
    {
         ...
         * @interface IObject
         * @brief The base interface for all audio objects.
         */
        ...
        public:
             ...
             * create any internal resources until it is actually referenced during
             ...
             * held resources whenever it has not been used during rendering
             ...
             * held resources whenever the object's owning renderer received a
             ...
             * In addition to resource suspension, this method also triggers an eviction
             * of any extra system memory resources (if possible) to free up even more memory.
             * Called by the IRenderer owning this object.
             * @return true if successful.
             */
...
#endif // __MURL_AUDIO_I_OBJECT_H__
