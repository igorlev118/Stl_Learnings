...
#ifndef __MURL_VIDEO_I_RENDERER_REGISTRY_H__
#define __MURL_VIDEO_I_RENDERER_REGISTRY_H__
...
namespace Murl
{
    namespace Video
    {
         ...
         * video renderer objects that can be instantiated using the Video::IRenderer implementing
         * this interface.
         */
...
#endif // __MURL_VIDEO_I_RENDERER_REGISTRY_H__
