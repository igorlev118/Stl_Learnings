...
#ifndef __MURL_GRAPH_I_CUBE_COLLIDER_H__
#define __MURL_GRAPH_I_CUBE_COLLIDER_H__
...
namespace Murl
{
    namespace Graph
    {
         ...
         * @brief The ICubeCollider graph node interface.
         * This interface represents a Graph::ICollider in the shape of a unit box
         * centered at the origin (0/0/0), with optional individual scaling factors
         * for all 3 axes.
         */
        class ICubeCollider : public IScalable
        {
        public:
            /**
        ...
        protected:
            virtual ~ICubeCollider() {}
        };
        
        typedef IGenericNodeTarget<ICubeCollider> ICubeColliderNodeTarget;
    }
}

#endif // __MURL_GRAPH_I_CUBE_COLLIDER_H__
