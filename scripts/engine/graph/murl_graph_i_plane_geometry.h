...
#ifndef __MURL_GRAPH_I_PLANE_GEOMETRY_H__
#define __MURL_GRAPH_I_PLANE_GEOMETRY_H__
...
namespace Murl
{
    namespace Graph
    {
        ...
        public:
             ...
             * rendering.
             * Use the index parameter to specify the actual set of texture coordinates
             * to modify, either 0 for TEXCOORD_0 or 1 for TEXCOORD_1.
            ...
            /**
             * @brief Get the width of the display rectangle.
             * @return The rectangle width.
             */
            virtual Real GetFrameSizeX() const = 0;
            /**
             * @brief Get the height of the display rectangle.
         ...
         * @brief A container for referencing one or more Graph::IPlaneGeometry nodes.
         */
        typedef IGenericNodeTarget<IPlaneGeometry> IPlaneGeometryNodeTarget;
    }
}

#endif // __MURL_GRAPH_I_PLANE_GEOMETRY_H__
