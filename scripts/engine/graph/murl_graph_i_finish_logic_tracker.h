...
#ifndef __MURL_GRAPH_I_FINISH_LOGIC_TRACKER_H__
#define __MURL_GRAPH_I_FINISH_LOGIC_TRACKER_H__
...
namespace Murl
{
    ...
    namespace Graph
    {
         ...
         * @interface IFinishLogicTracker
         * @brief The tracker used for logic finishing traversals.
         * This interface represents a graph state tracker used during Graph::INode::FinishLogic
         * traversals.
         */
        ...
        public:
            ...
            /**
             * @brief Get the logic processing tracker.
             * @return The tracker.
             */
            virtual IProcessLogicTracker* GetProcessTracker() const = 0;
            
        protected:
            virtual ~IFinishLogicTracker() {}
        };
    }
}

#endif // __MURL_GRAPH_I_FINISH_LOGIC_TRACKER_H__
