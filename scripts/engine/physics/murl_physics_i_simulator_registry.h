...
#ifndef __MURL_PHYSICS_I_SIMULATOR_REGISTRY_H__
#define __MURL_PHYSICS_I_SIMULATOR_REGISTRY_H__
...
namespace Murl
{
    namespace Physics
    {
         ...
         * The ISimulatorRegistry interface provides methods to add, remove and query different
         * physics simulator objects that can be instantiated using the Physics::ISimulator 
         * implementing this interface.
         */
        class ISimulatorRegistry
        {
        public:
            /**
        ...
        protected:
            virtual ~ISimulatorRegistry() {}
        };
    }
}

#endif // __MURL_PHYSICS_I_SIMULATOR_REGISTRY_H__
